...
@NgModule({
  ...
  providers: [
    ...
    { provide: PoolAllocationRequestsService, useClass: PoolAllocationRequestsConcreteService },
    { provide: PoolCleanupRequestsService, useClass: PoolCleanupRequestsConcreteService },
